...
# source('wgee_Nhat.R',echo=F)
options(width = 200)
rstan_options(auto_write = TRUE)
options(mc.cores = parallel::detectCores())
set.seed(123456)
data.raw <- as.data.frame(read_csv(paste("Data","measa.csv",sep = "/") ))
...
# save(dat.tmp2,file="Data/dat_raw_summary_incidence_rate_2.Rdata")
# dat.tmp<-dat.tmp2 %>% group_by(patid,age.at.infection,time.after.mv,period) %>% summarise(cases=sum(status))
# dat.tmp <- subset(dat.tmp,cases>0)
# save(dat.tmp,file="Data/dat_raw_summary_incidence_rate.Rdata")
load(file = "Data/dat_raw_summary_incidence_rate.Rdata")
load(file = "Data/dat_raw_summary_incidence_rate_2.Rdata")
