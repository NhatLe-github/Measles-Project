...
options(width = 200)
set.seed(123456)
data.raw <- as.data.frame(read_csv("D:/Measles-Project/Data/measa.csv")) %>% arrange(date.admit)
...
# save(data.total.main,file = "D:/Measles-Project/Data/data_total_main.Rdata")
load(file = "D:/Measles-Project/Data/data_total_main.Rdata")
...
colnames(tab) <- tab2[1,]
save(tab,file = "D:/Measles-Project/Results/Final/tab.Rdata")
...
save(dat.sum_wide,file = "D:/Measles-Project/Results/Final/dat_sum_wide.Rdata")
```
...
load(file = "D:/Measles-Project/Results/Final/tab.Rdata")
knitr::kable(tab)
```
...
# save(dat.sum_wide,file = "D:/Measles-Project/Results/Final/dat_sum_wide.Rdata")
load(file = "D:/Measles-Project/Results/Final/dat_sum_wide.Rdata")
...
ggdraw(p2)
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Figure1.tiff",   # The directory you want to save the file in
...
# # end_time <- Sys.time()
# # (time_consumed1<-end_time - start_time)
# save(data.total.main,file = "C:/Users/nhatlth/OneDrive/Measles_paper/Final Paper/Project_Measles_18EN/R-codes/D:/Measles-Project/Data/data_total_main.Rdata")
# load(file = "C:/Users/nhatlth/OneDrive/Measles_paper/Final Paper/Project_Measles_18EN/R-codes/D:/Measles-Project/Data/data_total_main.Rdata")
load(file = "D:/Measles-Project/Data/data_total_main.Rdata")
```
...
end_time <- Sys.time()
(time_consumed1<-end_time - start_time)
save(fit.gee.main_ar1,file="D:/Measles-Project/Results/Final/fit_gee_main_ar1.Rdata")
```
...
load(file="D:/Measles-Project/Results/Final/fit_gee_main_ar1.Rdata")
...
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Figure2B.tiff",   
    width = 7, 
    height = 8, dpi=450) 
p
...
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Figure2A.tiff",   
    width = 15, 
    height = 8, dpi=450) 
p
```
...
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Figure2C.tiff",   
    width = 15, 
    height = 8, dpi=450) 
p
```
...
end_time <- Sys.time()
(time_consumed1<-end_time - start_time)
save(fit.gee.interaction.overall,file="D:/Measles-Project/Results/Final/fit_gee_interaction_overall_ar1.Rdata")
```
...
```{r include=FALSE}
# load("D:/Measles-Project/Results/Final/fit_gee_interaction_overall_ar1.Rdata")
...
# save(ano_interact_overall,file="D:/Measles-Project/Results/Final/ano_interact_overall_compare_ar1.Rdata")

load(file="D:/Measles-Project/Results/Final/ano_interact_overall_compare_ar1.Rdata")
...
end_time <- Sys.time()
save(data.total.worse,file = "D:/Measles-Project/Data/data_total_worse_ar1.Rdata")
...
end_time <- Sys.time()
(time_consumed1<-end_time - start_time)
save(fit.gee.worse,file="D:/Measles-Project/Results/Final/fit_gee_worse_ar1.Rdata")
```


```{r message=FALSE, warning=FALSE, include=FALSE}
load(file="D:/Measles-Project/Results/Final/fit_gee_worse_ar1.Rdata")
...
p<-ggplot(dat,aes(x=time.after.mv, y=pred)) + geom_line(size=.75,color="#31a354")+
  ...
  theme(panel.grid.minor = element_blank(),axis.title.x = element_text(face="bold", colour="black", size=12, margin = margin(t = 20,r = 20,b =20, l = 20)),
        ...
        legend.key = element_rect(colour = NA),
        strip.text=element_text(face = "bold",size=15))  + coord_cartesian(ylim=c(-4,2),xlim=c(0,6)) 
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Supplementary Figures/S1_Figure.tiff",   
    width = 7, 
    height = 8, dpi=450) 
p
```
...
IRR.tab <- IRR.tab[,c("time.after.mv","IRR")]
colnames(IRR.tab) <- c("Time after measles","Incidence rate ratio(95% CI)")
save(IRR.tab,file = "D:/Measles-Project/Results/Final/IRR_tab_worse_ar1.Rdata")
...
load(file = "D:/Measles-Project/Results/Final/IRR_tab_worse_ar1.Rdata")
knitr::kable(IRR.tab)
```
...
end_time <- Sys.time()
(time_consumed1<-end_time - start_time)
save(data.total.main.sim,file = "D:/Measles-Project/Data/data_total_main_sim_ar1.Rdata")
load(file = "D:/Measles-Project/Data/data_total_main_sim_ar1.Rdata")
...
end_time <- Sys.time()
(time_consumed1<-end_time - start_time)
save(fit_sim,file="D:/Measles-Project/Results/Final/fit_sim_sex_ar1.Rdata")
```


```{r eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
load(file="D:/Measles-Project/Results/Final/fit_sim_sex_ar1.Rdata")
...
save(fit,file="D:/Measles-Project/Results/Final/fit_Sens1_sex_ar1.Rdata")
time.after.mv<-seq(2/52,6,by=0.01)
l<-length(time.after.mv)
mat<-as.matrix(ns(pmax(time.after.mv-14/365,0),kn=knots.time.af.mv-14/365,Bo = c(0,time.max-14/365))-matrix(rep(ns(0,kn=knots.time.af.mv-14/365,Bo = c(0,time.max-14/365)),each=l),nrow=l))
mat<-cbind(matrix(rep(rep(0,10),l),ncol=10),rep(1,l),mat)
...
dat$plo<-pred[,5]
dat$phi<-pred[,6]
save(dat,file="D:/Measles-Project/Results/Final/dat_sim_result_sex_ar1.Rdata")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
load(file="D:/Measles-Project/Results/Final/dat_sim_result_sex_ar1.Rdata")
p<-ggplot(dat,aes(x=time.after.mv, y=pred)) + geom_line(size=.75,color="#31a354")+
  geom_ribbon(data=dat,aes(ymin=plo, ymax=phi, x=time.after.mv), alpha = 0.3,fill="#31a354")+coord_cartesian(ylim=c(-3,4)) +
  scale_y_continuous("IRR relative to before measles",breaks = log(c(1/20,1/8,1/3,1,3,8,50)),labels=c("1/20","1/8","1/3",1,3,8,50))+
  scale_x_continuous("Time after measles infection [years]",limits = c(0,10),breaks=c(0,1:10),labels=c("0",1:10))+
  ...
  theme(panel.grid.minor = element_blank(),axis.title.x = element_text(face="bold", colour="black", size=12, margin = margin(t = 20,r = 20,b =20, l = 20)),
        ...
        legend.key = element_rect(colour = NA),
        strip.text=element_text(face = "bold",size=15))  + coord_cartesian(ylim=c(-4,2),xlim=c(0,6)) 
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Supplementary Figures/S2_Figure.tiff",   
    width = 7, 
    height = 8, dpi=450) 
p
...
```{r eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
load(file="D:/Measles-Project/Results/fit_Sens1_sex_ar1.Rdata")
...
```{r message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
#Make the interpreation table of the regression
load("D:/Measles-Project/Results/Final/fit_Sens1_sex_ar1.Rdata")
time.after.mv<-c(14/365,21/365,30.4/365,60.8/365,90.25/365,182.5/365,273.8/365,1,1.5,2,3,4,5,5.5,6)
l<-length(time.after.mv)
mat<-as.matrix(ns(pmax(time.after.mv-14/365,0),kn=knots.time.af.mv-14/365,Bo = c(0,time.max-14/365))-matrix(rep(ns(0,kn=knots.time.af.mv-14/365,Bo = c(0,time.max-14/365)),each=l),nrow=l))
mat<-cbind(matrix(rep(rep(0,10),l),ncol=10),rep(1,l),mat)
...
save(IRR.tabS1,file = "D:/Measles-Project/Results/Final/IRR_tabS1_ar1.Rdata")
```
...
load(file = "D:/Measles-Project/Results/Final/IRR_tabS1_ar1.Rdata")
...
end_time <- Sys.time()
(time_consumed1<-end_time - start_time)
save(data.total.main.sim_2,file = "D:/Measles-Project/Data/data_total_main_sim_2_ar1.Rdata")
```

```{r eval=FALSE, include=FALSE}
## We fit the Poisson regression mixed effect model with patient is a random intercept, the current age (age.at.infection) and time after MeV (time.after.mv) 
## are the main covariates.
load(file = "D:/Measles-Project/Data/data_total_main_sim_2_ar1.Rdata")
start_time <- Sys.time()
for(i in 1:length(emigration_r)){
  ...
  save(fit.gee.sim2,file=paste("D:/Measles-Project/Results/Final/fit_gee_sim2_",i,"_ar1.Rdata",sep=""))
}
...
for(i in 1:length(emigration_r)){
  load(file=paste("D:/Measles-Project/Results/Final/fit_gee_sim2_",i,"_ar1.Rdata",sep=""))
...
dat<-dat[-1,]
save(dat,file="D:/Measles-Project/Results/Final/dat_sim_2_result_ar1.Rdata")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
load(file="D:/Measles-Project/Results/Final/dat_sim_2_result_ar1.Rdata")
emigration_r<-c(0.01,seq(0.1,0.7,by=0.05))
emigration_r<-c(emigration_r,0.75,0.8,0.85,0.9,0.95,0.975)
...
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Supplementary Figures/S3_Figure.tiff",   
    width = 17, 
    height = 12, dpi=450) 
p
```
...
end_time <- Sys.time()
(time_consumed1<-end_time - start_time)
save(fit.gee.sens_13yrs,file="D:/Measles-Project/Results/Final/fit_gee_sens_13yrs_ar1.Rdata")
```


```{r message=FALSE, warning=FALSE, include=FALSE}
load(file="D:/Measles-Project/Results/Final/fit_gee_sens_13yrs_ar1.Rdata")
time.after.mv<-seq(2/52,6,by=0.01)
l<-length(time.after.mv)
mat<-as.matrix(ns(pmax(time.after.mv-14/365,0),kn=knots.time.af.mv-14/365,Bo = c(0,time.max-14/365))-matrix(rep(ns(0,kn=knots.time.af.mv-14/365,Bo = c(0,time.max-14/365)),each=l),nrow=l))
mat<-cbind(matrix(rep(rep(0,10),l),ncol=10),rep(1,l),mat)
...
p<-ggplot(dat,aes(x=time.after.mv, y=pred)) + geom_line(size=.75,color="#31a354")+
  ...
  theme(panel.grid.minor = element_blank(),axis.title.x = element_text(face="bold", colour="black", size=15, margin = margin(t = 20,r = 20,b =20, l = 20)),
        ...
        legend.key = element_rect(colour = NA),
        strip.text=element_text(face = "bold",size=15))  + coord_cartesian(ylim=c(-4,2),xlim=c(0,6)) 
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Supplementary Figures/S4_Figure.tiff",   
    width = 7, 
    height = 8, dpi=450) 
p
```
...
IRR.tab <- IRR.tab[,c("time.after.mv","IRR")]
colnames(IRR.tab) <- c("Time after measles","Incidence rate ratio(95% CI)")
save(IRR.tab,file = "D:/Measles-Project/Results/Final/IRR_tab_13yrs_ar1.Rdata")
```
...
load(file = "D:/Measles-Project/Results/Final/IRR_tab_13yrs_ar1.Rdata")
knitr::kable(IRR.tab)
```
...
#### Figure S8: Incidence of mortality due to Communicable, maternal, neonatal, and nutritional diseases by four countries from 1990-2017 *.

```{r echo=FALSE, fig.height=10, fig.width=12, message=FALSE, warning=FALSE}
dat<-as.data.frame(read_csv("D:/Measles-Project/Data/rate_death_ID_global_by_income.csv"))
...
# ggsave(file = "D:/Measles-Project/Results/Final/Figures/FigureS5.tiff",   
#     width = 15, 
#     height = 9) 
# p
...
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Supplementary Figures/S8_Figure.tiff",   
    width = 10, 
    height = 9) 
p
...
#### Figure S9: Global report on percent of total deaths due to infectious diseases in 2005 and 2015*.


```{r echo=FALSE, fig.height=7, fig.width=11, message=FALSE, warning=FALSE}
dat<-as.data.frame(read_csv("D:/Measles-Project/Data/death_ID_global_by_income.csv"))
dat<-plyr::rename(dat,c("Cause of death or injury"="Cause of death"))
dat<-subset(dat,select=c("Location","Year","Age","Value","Lower bound","Upper bound","Cause of death"))
colnames(dat)<-c("Location","Year","Age","Value","Lower_bound","Upper_bound","Cause_of_death")
dat$Location<-substr(dat$Location,12,30)
...
p<-ggplot(subset(dat,Year==2015),aes(x = Location, y = Value,color=Age))+labs(fill="Countries")+geom_point(size=1.5,position = position_dodge(width=0.3))+scale_color_manual(values=c("#f03b20","#3182bd"))+facet_wrap(~Cause_of_death,scales="free_y",nrow=2) + geom_errorbar(aes(x = Location,ymin = Lower_bound,ymax = Upper_bound),width=0.5,position = position_dodge(width=0.3))+ylab("Probability of death due to infectious diseases ")+theme_bw() +
    theme(axis.title.x = element_text(face="bold", colour="black", size=15, margin = margin(t = 20,r = 20,b =20, l = 20)),
        ...
        strip.text=element_text(face = "bold",size=15),
        plot.title=element_text(family='', face='bold', colour='black', size=15))
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Supplementary Figures/S9_Figure.tiff",   
    width = 10, 
    height = 9) 
p
```
...
#### Figure S10: Incidence of hospitalization due to measles in HCMC.
...
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Supplementary Figures/S10_Figure.tiff",     width = 7, # The width of the plot in inches
...
save(cstHazard_ar1,file="D:/Measles-Project/Results/Final/cstHazard_main_ar1.Rdata")
```


```{r echo=FALSE}
load(file="D:/Measles-Project/Results/Final/cstHazard_main_ar1.Rdata")
...
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Supplementary Figures/S5_Figure.tiff",   
    width = 7, 
    height = 8, dpi=450) 
p
```
...
end_time <- Sys.time()
(time_consumed1<-end_time - start_time)
save(fit.gee.main_ar1_year,file="D:/Measles-Project/Results/Final/fit_gee_main_ar1_year.Rdata")
```



```{r message=FALSE, warning=FALSE, include=FALSE}
load(file="D:/Measles-Project/Results/Final/fit_gee_main_ar1_year.Rdata")
time.after.mv<-seq(2/52,10,by=0.01)
l<-length(time.after.mv)
time.max<-5
mat<-as.matrix(ns(pmax(time.after.mv-14/365,0),kn=knots.time.af.mv-14/365,Bo = c(0,time.max-14/365))-matrix(rep(ns(0,kn=knots.time.af.mv-14/365,Bo = c(0,time.max-14/365)),each=l),nrow=l))
...
p<-ggplot(dat,aes(x=time.after.mv, y=pred)) + geom_line(size=.75,color="#31a354")+
  ...
  theme(panel.grid.minor = element_blank(),axis.title.x = element_text(face="bold", colour="black", size=15, margin = margin(t = 20,r = 20,b =20, l = 20)),
        ...
        strip.text=element_text(face = "bold",size=15))  + coord_cartesian(ylim=c(-4,2),xlim=c(0,6)) 
p
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Supplementary Figures/S6_Figure.tiff",   
    width = 7, 
    height = 8, dpi=450) 
p
...
end_time <- Sys.time()
(time_consumed1<-end_time - start_time)
save(fit.gee.sens_4yrs,file="D:/Measles-Project/Results/Final/fit_gee_sens_4yrs_ar1.Rdata")
```
...
knots.age<-c(1/2,1,1.5,2,2.5,3)
start_time <- Sys.time()
load(file="D:/Measles-Project/Results/Final/fit_gee_sens_4yrs_ar1.Rdata")
...
ggsave(file = "D:/Measles-Project/Results/Final/Figures/Supplementary Figures/S7_Figure.tiff",   
    width = 6, 
    height = 5, dpi=450) 
p
```
